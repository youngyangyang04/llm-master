---
title: 工具设计决定Agent上限：Tool Use、Function Calling、参数Schema和返回值怎么设计
description: Agent工具设计怎么做？本文围绕Tool Use和Function Calling，系统讲解工具描述、参数Schema、返回值设计、工具粒度、权限边界、错误处理和可观测性，说明为什么工具设计决定Agent上限，并给出大模型应用开发和Agent面试回答框架。
keywords: ["Agent工具设计", "AI Agent工具调用", "Tool Use", "Function Calling", "工具描述", "参数Schema", "Agent返回值设计", "Agent权限控制", "Agent工具粒度", "Agent面试", "大模型应用开发"]
tags: ["大模型应用", "AI Agent", "工具调用", "大模型面试"]
---
