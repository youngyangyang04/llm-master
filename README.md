...
| 方向 | 核心内容 | 学习入口 |
|---|---|---|
| AI使用 | ChatGPT、GPT-6 Astra、Claude Opus 5、Fable 5.1| [会员充值](https://github.com/youngyangyang04/gpt-daichong)、[API调用](https://github.com/youngyangyang04/chatgpt-claude-api) |
